...
public class SATMGUI extends JFrame {
	...
	public SATMGUI() {
		...
		Screen1 scrn1 = new Screen1();
		Screen2 scrn2 = new Screen2();
		...
		contentPane.add(scrn1, "1");
		contentPane.add(scrn2, "2");
