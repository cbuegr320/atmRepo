...
public class Screen10 extends JPanel {
	...
	public Screen10() {
		...
		JLabel lblNewLabel = new JLabel("Temporarily unable to process withdrawals");
		lblNewLabel.setFont(new Font("Avenir Next", Font.PLAIN, 18));
		lblNewLabel.setBounds(74, 227, 352, 25);
		add(lblNewLabel);
		...
		tryAgainButton.setBounds(109, 378, 282, 41);
		add(tryAgainButton);
	}
